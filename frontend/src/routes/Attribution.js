export default function Attribution(){
    return (
        <div className="story">
            ...
            <p><a href="https://www.freepik.com/free-vector/blue-watercolour-banner-white-border_43397984.htm#query=text%20background&position=1&from_view=keyword&track=ais">Image by juicy_fish</a> on Freepik</p>
        </div>
    )
}