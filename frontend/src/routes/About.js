export default function About(){
    return(
        <div>
            ...
            <p>
                Fast forward decades and several carrers later, and here I am finally making 
                this dream come true thanks to the USF's Software Engineering bootcamp
                powered by rithmschool.  
            </p>
            <p>
                Feel free to create an account and try it out.  You can create a single
                mealplan for your family, or one for each member if you have people with
                unique requirements like mine.  Search for meal to add to you calendar
                and access nutrition information and your shopping list based on what
                you have scheduled to prepair.  There is even a link to the cooking 
                instructions in every meal.  
            </p>
            <p>
